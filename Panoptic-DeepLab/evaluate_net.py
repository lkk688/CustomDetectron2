...
def main(args):
    ...
    metalist=MetadataCatalog.list()
    panoptic_name="coco_2017_val_panoptic"#"coco_2017_train_panoptic_separated"#"coco_2017_train_panoptic"
    ...
    mymetadataCatalog, instance_train_meta=mypanopticdatasetregister(mypanoptic_name, image_root, panoptic_root, panoptic_json, instances_json, instancedataset_name="mycoco_2017_train")

    myvalpanoptic_name='mycoco_2017_val_panoptic'
    valimage_root='/DATA5T2/Datasets/COCO2017/coco/images/val2017/'
    valpanoptic_root='/DATA5T2/Datasets/COCO2017/coco/annotations/panoptic_val2017/' #directory which contains panoptic annotation images
    valpanoptic_json='/DATA5T2/Datasets/COCO2017/coco/annotations/panoptic_val2017.json'
    valsem_seg_root= '/DATA5T2/Datasets/COCO2017/coco/panoptic_stuff_val2017/'#directory which contains all the ground truth segmentation annotations.
    valinstances_json='/DATA5T2/Datasets/COCO2017/coco/annotations/instances_val2017.json'
    myvalmetadataCatalog, instance_val_meta=mypanopticdatasetregister(myvalpanoptic_name, valimage_root, valpanoptic_root, valpanoptic_json, valinstances_json, instancedataset_name="mycoco_2017_val")
